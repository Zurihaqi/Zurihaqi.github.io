...
const ContactSection = React.forwardRef((_props, ref) => {
  return (
    <section
      ref={ref}
      id="contact"
      className="container pb-24 border-t-2 dark:bg-[#161616] bg-white dark:border-t-zinc-700 rounded-t-xl"
    >
      ...
      <div className="flex sm:flex-row flex-col items-center p-4">
        <div className="sm:px-4 mb-4 sm:mb-0 text-center sm:w-1/2 w-full">
          ...
          <p className="mt-2">
            ...
            <span className="font-semibold dark:text-violet-600 text-blue-400">
