...
const Card = ({ image, img_alt, title, description, category, onClick }) => {
  ...
  return (
    <div
      className="rounded-lg shadow-xl bg-white dark:bg-zinc-800 bg-opacity-50"
      style={{ minHeight: 350, maxHeight: 350 }}
    >
      <div className="group relative flex justify-center">
        <GatsbyImage
          className="rounded-lg w-[500px] h-[200px] object-contain group-hover:brightness-50 transition-all duration-300"
